...
FLAGS_HYDRO = $(CUDA) $(PRECISION) $(CPU_TIME) $(OUTPUT) $(RECONSTRUCTION) $(SOLVER) $(INTEGRATOR) $(H_CORRECTION)  $(DUAL_ENERGY)  $(SCALAR) $(REVERT_STEP) $(DENSITY_FLOOR) $(TEMPERATURE_FLOOR) $(DE_EKINETIC_LIMIT) $(CELL_SMOOTHING)
...
FLAGS_COOLING = $(COOLING) $(GRACKLE_PRECISION) $(OUTPUT_COOLING_RATE) $(OUTPUT_CHEMISTRY) $(GRACKLE_METAL_COOLING)
